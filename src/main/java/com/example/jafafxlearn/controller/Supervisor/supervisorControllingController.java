...
public class supervisorControllingController implements Initializable, BasicIntegrationDB {
    ...
    private void controll(int id, String tipe) {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/supervisor/ControllingModal.fxml"));
            Parent root = loader.load();
            supervisorControllingModalController myc = loader.getController();
            myc.setTipe(tipe);
            myc.setId(id);
